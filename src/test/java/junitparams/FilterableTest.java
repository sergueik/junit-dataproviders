...
public class FilterableTest {
	...
	public void shouldRunSingleTestWithoutParameters() throws Exception {
		Request request = requestSingleMethodRun(SampleTestCase.class,
				"firstTestMethod");
	...
	@Test
	public void shouldReturnParametrizedDescriptionsForParametrizedTestCase()
			throws Exception {
		Request request = requestSingleMethodRun(SampleTestCase.class,
				"secondTestMethod");
	...
	private Request requestSingleMethodRun(Class<SampleTestCase> clazz,
			String methodName) {
