...
public class SimpleIterableResultToArrayTest {
	...
	public void testSimpleIterableObjectArray() throws Exception {
		Object[] actual = convert(asList((Object[]) arr("SNARK", "BOOJUM")));

		assertThat(actual).isEqualTo(arr(arr("SNARK"), arr("BOOJUM")));
	}

	@Test
	public void testSimpleIterable() throws Exception {

		Object[] actual = convert(asList("SNARK", "BOOJUM"));
	...
	public void testNestedManyIterable() throws Exception {
		...
		Object[] actual = convert(asList(asList("SNARK", "BOOJUM"),
				asList("SNARK", "BOOJUM"), asList("SNARK", "BOOJUM")));
