...
public class TestMethodTest {
	...
	public void setUp() throws Exception {
		plainTestMethod = new TestMethod(new FrameworkMethod(TestMethodTest.class
				.getMethod("forOthersToWork", new Class[] { String.class })),
				new TestClass(this.getClass()));
		arrayTestMethod = new TestMethod(
				new FrameworkMethod(
						TestMethodTest.class.getMethod("forOthersToWorkWithArray",
	...
	public void flatTestMethodStructure() throws Exception {
		...
		assertEquals("for_others_to_work(junitparams.internal.TestMethodTest)",
	...
	public void hierarchicalTestMethodStructure() throws Exception {
		...
		assertEquals("forOthersToWork(a) [0](junitparams.internal.TestMethodTest)",
				description.getChildren().get(0).getDisplayName());
		assertEquals("forOthersToWork(b) [1](junitparams.internal.TestMethodTest)",
	...
	public void hierarchicalArrayTestMethodStructure() throws Exception {
		...
		assertEquals(
				"forOthersToWorkWithArray(a,b) [0](junitparams.internal.TestMethodTest)",
				description.getChildren().get(0).getDisplayName());
		assertEquals(
				"forOthersToWorkWithArray(b,a) [1](junitparams.internal.TestMethodTest)",
				description.getChildren().get(1).getDisplayName());
	}
	...
	protected Object parametersForTestVarargsMoreArgs() {
		return new Object[] {
				new Object[] { 40, 50, new Pair(17, 21), new Pair(12, 18),
						new Pair(11, 11) },
				new Object[] { 10, 20, new Pair(3, 15), new Pair(7, 5) } };
	}
	...
	protected Object parametersForTestVargsMoreArgsOfTheSameType() {
		return new Object[] {
				new Object[] { new Pair(10, 30), new Pair(7, 17), new Pair(3, 13) },
				new Object[] { new Pair(20, 40), new Pair(18, 21), new Pair(2, 19) } };
	}

	@Test
	@Parameters(method = "nullArray")
	public void varargsCheckPassesWithNullArray(boolean isNull, String... array)
			throws Exception {
		assertEquals(isNull, array == null);
	}

	private Object nullArray() {
		return new Object[] { new Object[] { false, new String[] { "1", "2" } },
