...
public class MacroSubstitutionNamingStrategyTest {
	...
	public Object parametersForTestNaming() {
		return new Object[] {
				new Object[] { "withoutTestCaseAnnotation",
						"withoutTestCaseAnnotation(value) [0]" },
				new Object[] { "withAnnotationWithoutTemplate",
						"withAnnotationWithoutTemplate(value) [0]" },
				new Object[] { "withEmptyTemplate", "withEmptyTemplate(value) [0]" },
				new Object[] { "whenTemplateResultedToEmptyName",
						"whenTemplateResultedToEmptyName(value) [0]" },
				new Object[] { "withoutMacro", "plain name" },
				new Object[] { "withIndexMacro", "0" },
				new Object[] { "withParamsMacro", "value" },
				new Object[] { "withMethodNameMacro", "withMethodNameMacro" },
				new Object[] { "withCombinationOfMacros",
						"0: withCombinationOfMacros(value)" },
				new Object[] { "withMacroNameWrittenInDifferentCase",
						"value value value" },
				new Object[] { "withMethodParameterIndexInsideArgumentsArray",
						"value" },
				new Object[] { "withMethodParameterIndexOutsideArgumentsArray",
						"Here is 100 argument:" },
				new Object[] { "whenGivenMacroDoesntExist", "{not_existing_macro}" } };
	}

	@Test
	@Parameters
	public void testNaming(String methodName, String expectedTestCaseName)
			throws NoSuchMethodException {
		TestCaseNamingStrategy strategy = createNamingStrategyForMethod(methodName,
				String.class);
	...
	private TestCaseNamingStrategy createNamingStrategyForMethod(String name,
			Class... parameterTypes) throws NoSuchMethodException {
		TestMethod method = getCurrentClassMethod(name, parameterTypes);

		return new MacroSubstitutionNamingStrategy(
				method.getAnnotation(TestCaseName.class), method.name());
	}

	private TestMethod getCurrentClassMethod(String name, Class... parameterTypes)
			throws NoSuchMethodException {
		final Method method = MacroSubstitutionNamingStrategyTest.class
