...
public class ParamsConverterTest {
	...
	@Test
	@Parameters({ "01.12.2012" })
	public void convertParamsUsingParamAnnotation(
			@Param(converter = SimpleDateConverter.class) Date date) {
		Calendar calendar = createCalendarWithDate(date);
		assertCalendarDate(calendar);
	}
	...
	@Test
	@Parameters("2")
	public void useMultipleConvertersFromLeftToRight(
			@TimesTwo @PlusTwo Integer param) throws Exception {
	...
	@Test
	@Parameters(method = "params")
	public void convertParamsFromMethodUsingCustomParamAnnotation(
			@DateParam Date date) {
		Calendar calendar = createCalendarWithDate(date);
		assertCalendarDate(calendar);
	}
	...
	public void convertParamsUsingCustomParamAnnotationOverridingAttributes(
			@DateParam(format = "yyyy-MM-dd") Date date) {
		Calendar calendar = createCalendarWithDate(date);
		assertCalendarDate(calendar);
	}
	...
	public void passesParametersWithOtherAnnotations(@Other String parameter) {
		assertThat(parameter).isExactlyInstanceOf(String.class)
	...
	public static class FormattedDateConverter
			implements Converter<DateParam, Date> {
