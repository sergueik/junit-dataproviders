...
public class SamplesOfUsageTest {
	...
	private Object parametersForParamsInDefaultMethod() {
		return new Object[] { new Object[] { "AAA", 1 },
				new Object[] { "BBB", 2 } };
	}
	...
	private List<List<String>> parametersForParamsInIterableOfIterables() {
		return Arrays.asList(Arrays.asList("s01e01", "s01e02"),
	...
	private PersonType[] parametersForEnumsAsParamsInMethod() {
		return new PersonType[] { PersonType.SOME_VALUE };
	}
	...
	private Object parametersForWrapParamsWithConstructor() {
		return new Object[] { new Object[] { "first", 1 },
				new Object[] { "second", 2 } };
	}
	...
	public void convertParams(
			@Param(converter = ParamsConverterTest.SimpleDateConverter.class) Date date) {
	}
	...
	public void usageOfMultipleTypesOfParameters(boolean booleanValue,
			int[] primitiveArray, String stringValue, String[] stringArray) {
	}
